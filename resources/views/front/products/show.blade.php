<x-front_layout :title="$product->name">
    <x-slot:breadcrumb>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{Currency::format( $product->price )}}@if ($product->compare_price)
                                <span>{{Currency::format( $product->compare_price) }}</span></h3> @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="battery-capacity" name="battery_capacity">
                                                <!-- إضافة name هنا -->
