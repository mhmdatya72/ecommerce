...
<div class="form-group">
    ...
    <select name="parent_id" id="parent_id" class="form-control">
        ...
        <option value="{{ $parentItem->id }}" @if(isset($category) && $category->parent_id == $parentItem->id) selected @endif>
            {{ $parentItem->name }}
        </option>
        @endforeach
    </select>
...
<div class="form-group">
    ...
    <div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" value="active" @if(isset($category) && $category->status == 'active') checked @endif>
            <label class="form-check-label">Active</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" value="archived" @if(isset($category) && $category->status == 'archived') checked @endif>
